...
Security engineer passionate about identifying vulnerabilities and building secure systems.
Experienced in **Application Security, Web Security, and Penetration Testing**.

I enjoy building tools, performing security assessments, and researching vulnerabilities.
...
**Tools**
Burp Suite • OWASP ZAP • Nmap • Metasploit • Wireshark • Gobuster • Nikto
...
Python tool that automates subdomain enumeration, port scanning, and vulnerability discovery.

💥 **Web Vulnerability Lab**
Collection of vulnerable web apps demonstrating OWASP Top 10 attacks.

🛡 **Secure Code Review Checklist**
Practical secure coding checklist for developers.

📊 **Bug Bounty Writeups**
Real vulnerability discoveries and exploitation techniques.

---

## 📚 Learning Projects

* Restart75 – Cybersecurity learning challenge
* 100 Days of Security Learning

---

## 📈 GitHub Stats

![Stats](https://github-readme-stats.vercel.app/api?username=rakeshelamaran98\&show_icons=true)
